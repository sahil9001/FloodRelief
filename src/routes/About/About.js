    ...
    return (
      <div className="container mx-auto my-12">
        <div className="mx-auto">
          <p className="font-roboto text-center text-5xl font-medium tracking-wide">
            Meet the Team
          </p>
          <div className="grid grid-cols-3 gap-4 py-12">
            <div className="col-start-2">
              <p className="font-roboto text-center text-xl leading-relaxed font-medium tracking-wide">
